    ...
    <div class="container">
        ...
        <div class="bg-white rounded shadow p-2 mt-4" style="min-height:80vh">
            <div class="d-flex justify-content-between border-bottom">
                <h5>Create Resume</h5>
                <div>
                <a href="myresumes.php" class="text-decoration-none"><i class="bi bi-arrow-left-circle"></i> Back</a>                </div>
            </div>
            ...
            <div>
                ...
                <h5 class="mt-3 text-secondary"><i class="bi bi-person-badge"></i> Personal Information</h5>
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" name="address"value="<?=@$resume['address']?>" id="inputAddress" placeholder="1234 Main St">
                    </div>
...
<div class="col-12 col-md-6 p-2">
                            <div class="p-2 border rounded">
                                ...
                                <p class="small text-secondary m-0" style="">
                                    if you have experience than you can add it 
                                </p>
...
<div class="col-12 col-md-6 p-2">
                            <div class="p-2 border rounded">
                                <div class="d-flex justify-content-between">
                                    <h6>I am no education</h6>
                                </div>

                                <p class="small text-secondary m-0" style="">
                                    if you have education than you can add it 
                                </p>
...
?>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <a href="actions/deleteedu.action.php?id=<?=$exp['id']?>&resume_id=<?=$resume['id']?>&slug=<?=$resume['slug']?>" class="text-decoration-none" data-bs-toggle="modal" data-bs-target="#addskill"><i class="bi bi-file-earmark-plus"></i> Add New</a>
                        </div>
                    </div>
